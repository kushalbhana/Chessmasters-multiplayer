...
export default function LoginPage() {
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2 bg-slate-200 overflow-hidden">
      {/* Left Section */}
      <div className="flex flex-col items-center justify-center gap-8 px-4 sm:px-6 md:px-10 py-8">
        {/* Logo */}
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-md bg-primary text-black">
            <FaChessQueen />
          </div>
          <h1 className="text-black text-xl sm:text-2xl font-bold whitespace-nowrap text-center">
