    ...
    return (
        <div className="w-full h-full flex flex-col gap-2">
            <div className="pt-6 flex gap-4 flex-wrap justify-center items-center">
                ...
                <div className="flex justify-center items-center rounded-2xl hover:bg-red-700 hover:cursor-pointer">
                    <FaMicrophone className="text-lg"/>
                </div>
                <div className="hidden lg:block">
                    <DropdownInGame/>
                </div>
                <div className="flex justify-center items-center rounded-2xl hover:bg-red-700 h-6 w-6 hover:cursor-pointer">
