...
export function VictoryDialog({ open, onClose,  myImg, oppositeImg }: VictoryDialogProps) {
  const GameStatus = useRecoilValue(gameResult);
            ...
            <CardContent className="py-10 px-6 space-y-6">
             <div className="flex flex-col items-center justify-center">
                ...
                <div className="flex items-center gap-4 justify-center mt-4">
                  <div >
                    <img src={myImg} alt="Player-1"  className="rounded-full h-16 w-16"/>
                  </div>
                  <div className="font-bold">
                    VS
                  </div>
                  <div>
                    <img src={oppositeImg} alt="Player-2" className="rounded-full h-16 w-16"/>
                  </div>
                </div>
                <div className="mt-8">
